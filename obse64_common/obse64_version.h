...
#define OBSE64_VERSION_INTEGER		    0
#define OBSE64_VERSION_INTEGER_MINOR	1
#define OBSE64_VERSION_INTEGER_BETA     0
#define OBSE64_VERSION_VERSTRING		"0, 0, 1, 0"
#define OBSE64_VERSION_PADDEDSTRING     "0001"
#define OBSE64_VERSION_RELEASEIDX       1
...
#define RUNTIME_VERSION_0_411_140	MAKE_EXE_VERSION(0, 411, 140)	// 0x40C9E188	initial Steam release

#define PACKED_OBSE64_VERSION		MAKE_EXE_VERSION(OBSE64_VERSION_INTEGER, OBSE64_VERSION_INTEGER_MINOR, OBSE64_VERSION_INTEGER_BETA)

// information about the state of the game at the time of release
#define OBSE64_TARGETING_BETA_VERSION	0
#define CURRENT_RELEASE_RUNTIME		RUNTIME_VERSION_0_411_140
#define CURRENT_RELEASE_OBSE64_STR	"0.1.0"
